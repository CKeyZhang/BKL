...
# MLKD CFG
CFG.MLKD = CN()
CFG.MLKD.TEMPERATURE = 2.0
CFG.MLKD.LOSS = CN()
CFG.MLKD.LOSS.CE_WEIGHT = 0.1
CFG.MLKD.LOSS.KD_WEIGHT = 0.9
...
# ReviewKD CFG
CFG.REVIEWKD = CN()
CFG.REVIEWKD.CE_WEIGHT = 0.1
CFG.REVIEWKD.KD_WEIGHT = 0.9
